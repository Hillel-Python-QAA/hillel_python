...
def car_searcher(cars_list, year, engine, price):
    ...
    for car in cars_list:
        if (cars_list[car][1] >= year and
        cars_list[car][2] >= engine and
        cars_list[car][4] <= price):
...
grades_1 = {'Анна Коваленко': 90, 'Олег Петров': 85, 'Ірина Сидорова': 78, 'Khhj IJj':89}
grades_2 = {'Анна Коваленко': 92, 'Олег Петров': 87, 'Ірина Сидорова': 80, 'iuiui IJj':89}
